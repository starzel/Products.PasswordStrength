...
from Products.PasswordStrength.plugin import PLUGIN_ID
from Products.PasswordStrength.plugin import PLUGIN_TITLE
from Products.PasswordStrength.plugin import PROJECTNAME
